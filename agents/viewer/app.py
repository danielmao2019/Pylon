...
class AgentsViewerApp(BaseAgent):
    ...
    def __init__(
        ...
        self.app.layout = create_layout(config_files, expected_files, epochs, sleep_time, outdated_days, self.system_monitor, user_names)
        register_callbacks(self.app, config_files, expected_files, epochs, sleep_time, outdated_days, self.system_monitor, user_names)
