...
from data.viewer.callbacks.backend_sync_3d_settings import (
    register_backend_sync_3d_settings_callbacks,
)
from data.viewer.callbacks.backend_sync_dataset import (
    register_backend_sync_dataset_callbacks,
)
from data.viewer.callbacks.backend_sync_navigation import (
    register_backend_sync_navigation_callbacks,
)
from data.viewer.callbacks.camera_reset import register_camera_reset_callbacks
from data.viewer.callbacks.camera_sync import register_camera_sync_callbacks
from data.viewer.callbacks.class_distribution import (
    register_class_distribution_callbacks,
)
from data.viewer.callbacks.dataset_group_reload import (
    register_dataset_group_reload_callbacks,
)
from data.viewer.callbacks.dataset_load import register_dataset_load_callbacks
from data.viewer.callbacks.dataset_options import register_dataset_options_callbacks
from data.viewer.callbacks.navigation_current_index import (
    register_navigation_current_index_callbacks,
)
from data.viewer.callbacks.navigation_datapoint_from_camera import (
    register_navigation_datapoint_from_camera_callbacks,
)
from data.viewer.callbacks.navigation_datapoint_from_navigation import (
    register_navigation_datapoint_from_navigation_callbacks,
)
from data.viewer.callbacks.navigation_datapoint_from_settings import (
    register_navigation_datapoint_from_settings_callbacks,
)
from data.viewer.callbacks.navigation_next import register_navigation_next_callbacks
from data.viewer.callbacks.navigation_prev import register_navigation_prev_callbacks
from data.viewer.callbacks.three_d_settings_density import (
    register_three_d_settings_density_callbacks,
)
from data.viewer.callbacks.three_d_settings_density_controls import (
    register_three_d_settings_density_controls_callbacks,
)
from data.viewer.callbacks.three_d_settings_lod_info import (
    register_three_d_settings_lod_info_callbacks,
)
from data.viewer.callbacks.three_d_settings_lod_type import (
    register_three_d_settings_lod_type_callbacks,
)
from data.viewer.callbacks.three_d_settings_point_opacity import (
    register_three_d_settings_point_opacity_callbacks,
)
from data.viewer.callbacks.three_d_settings_point_size import (
    register_three_d_settings_point_size_callbacks,
)
from data.viewer.callbacks.three_d_settings_radius import (
    register_three_d_settings_radius_callbacks,
)
from data.viewer.callbacks.three_d_settings_view_controls import (
    register_three_d_settings_view_controls_callbacks,
)
from data.viewer.callbacks.transforms import register_transforms_callbacks
from data.viewer.callbacks.transforms_section import (
