...
from data.viewer.callbacks.three_d_settings_helpers import _build_3d_settings_payload
...
def register_three_d_settings_point_size_callbacks(
    ...
    @debounce
    def update_3d_settings_point_size(
        ...
        """Update 3D settings store when point size changes."""
        # Input validations
