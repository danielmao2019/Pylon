...
from data.viewer.callbacks.navigation_helpers import _build_display_content

if TYPE_CHECKING:
    from data.viewer.viewer import DatasetViewer


def register_navigation_datapoint_from_camera_callbacks(
    ...
    def update_datapoint_from_camera(
