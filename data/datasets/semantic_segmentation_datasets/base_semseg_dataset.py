    ...
    def display_datapoint(
        ...
        fig_components = [
            ...
            html.Div(
                [
                    dcc.Graph(
                        figure=create_segmentation_figure(seg, title="Segmentation Map")
                    )
                ],
                style=DisplayStyles.GRID_ITEM_50,
            ),
        ...
        stats_data = [get_image_display_stats(image), get_segmentation_stats(seg)]
        titles = ["Image Statistics", "Segmentation Statistics"]
        stats_components = create_statistics_display(
            stats_data, titles, width_style="50%"
        )
