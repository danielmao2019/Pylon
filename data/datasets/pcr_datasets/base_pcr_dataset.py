...
class BasePCRDataset(BaseDataset):
    ...
    def _compute_transform_info(transform: torch.Tensor) -> Dict[str, Any]:
        ...
        Args:
            transform: Rigid 4x4 homogeneous transformation matrix applied to column-vector points (a point maps as transform @ [x, y, z, 1]), as a floating `torch.Tensor` of shape [4, 4], on any device.
