...
@pytest.mark.parametrize("dataset", [
    (LevirCdDataset(data_root="./data/datasets/soft_links/CDD", split='train')),
    (LevirCdDataset(data_root="./data/datasets/soft_links/CDD", split='test')),
    (LevirCdDataset(data_root="./data/datasets/soft_links/CDD", split='val')),
])
