"""Seam-safe canonical canonicalization of UV data for `MeshTextureUVTextureMap`."""
...
def shift_seam_crossing_faces_to_seam_safe(
    ...
    if bool(shared_row_mask.any().item()):
        ...
        for shared_row_index_item in shared_rows.tolist():
            ...
            if shared_u >= 0.5:
                continue
            new_row = canonical_verts_uvs[shared_row_index : shared_row_index + 1].clone()
            new_row[0, 0] = new_row[0, 0] + 1.0
