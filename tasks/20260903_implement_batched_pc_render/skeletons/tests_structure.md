...
├── The scenes reach pixels that many points land on, a cloud of so few points that CUDA picks its small-matrix kernels for the whole cloud, points behind some cameras, and points outside some images.
