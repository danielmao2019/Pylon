goal: initialize code skeleton docs and restructure mesh texture extraction module
...
2. references:
   1. existing `./docs/code_structure/data/structures/three_d/mesh/` — style reference for the new model-layer skeletons, AND the active spec for any data-layer code added by this task (so back-propagate updates to it as needed).
