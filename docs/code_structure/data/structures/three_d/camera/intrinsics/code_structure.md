...
│   │   │   └── return params
│   │   └── assert 0, "Should not reach here."
│   ├── calls _to_standard(params=params)  # -> params, on the standard frame
...
│   │   │   └── return params
│   │   └── assert 0, "Should not reach here."
│   ├── calls _from_standard(params=params)  # -> params, on the target frame
...
│   ├── calls _reverse_axes(params=params, axes=("y",))  # -> params
│   ├── calls _uncentre_principal_point(params=params)  # -> params
...
│   ├── calls _reverse_axes(params=params, axes=("x", "y"))  # -> params
│   ├── calls _uncentre_principal_point(params=params)  # -> params
│   └── return  # params, on the standard frame
...
│   ├── calls _reverse_axes(params=params, axes=("y",))  # -> params; standard's y runs toward the bottom edge and OpenGL's toward the top
│   ├── calls _rescale_intr_params(params=params, model=model, unit_x=unit_x, unit_y=unit_y)  # -> params
