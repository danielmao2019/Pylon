...
│   │   └── return container
│   ├── impls leaf = the LeafVNode keyed by displayResponse.url or `aabb_3d:${displayResponse.slot_id}`, with empty props and that render
│   └── return leaf
...
│   └── return  # the THREE.Sprite carrying spriteMaterial
