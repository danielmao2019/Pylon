# criteria/vision_2d — code structure

## 1. Code structure trees

`criteria/vision_2d/__init__.py`
...
└── __all__  # Tuple[str, ...] — the three dense-prediction base classes, the seven criteria of the dense_classification package (five DenseClassificationCriterion subclasses plus two HybridCriterion compositions), the three dense-regression criteria, and the change_detection subpackage
```
