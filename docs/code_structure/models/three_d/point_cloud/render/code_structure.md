...
│   ├── calls prepare_points_for_rendering(pc=pc, camera=camera, resolution=resolution)  # -> _, valid
│   ├── impls image_plane_points_indices = the point indices where valid is True
