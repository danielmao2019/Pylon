    ...
    for bbox_score in scores:
        for area in areas:
            for limit in limits:
                ...
                assert set(bbox_score[key].keys()) == {
                    'per_bbox',
                    'AR',
                    'recalls',
                    'thresholds',
...
def test_object_detection_metric_summarize(y_preds, y_trues, areas, limits):
    ...
    for area in areas:
        for limit in limits:
            ...
            assert set(result['aggregated'][key].keys()) == {
                'AR',
                'recalls',
                'thresholds',
            }
    ...
    for area in areas:
        for limit in limits:
            ...
            assert set(result['per_datapoint'][key].keys()) == {
                'AR',
                'recalls',
                'thresholds',
            }
