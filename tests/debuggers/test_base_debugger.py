...
def test_dummy_debugger_different_outputs(
    dummy_debugger, dummy_model, output_tensor, description
):
...
def test_another_dummy_debugger_call(
    another_dummy_debugger, sample_datapoint, dummy_model
):
...
@pytest.mark.parametrize(
    "output_key", ["custom_key", "special_stats", "my_debug_output"]
)
