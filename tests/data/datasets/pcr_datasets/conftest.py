...
@pytest.fixture
def threedmatch_dataset_config(
    request, threedmatch_data_root, use_cpu_device, get_device
):
...
@pytest.fixture
def threedlomatch_dataset_config(
    request, threedmatch_data_root, use_cpu_device, get_device
):
...
@pytest.fixture
def modelnet40_dataset_config(
    request, modelnet40_data_root, modelnet40_cache_file, use_cpu_device, get_device
):
