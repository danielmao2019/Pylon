...
def dataset_with_params(request):
    """Fixture for creating a SingleTemporalPCRDataset instance with validation parameters."""
    ...
    dataset = data.datasets.SingleTemporalPCRDataset(**dataset_params)
...
def test_single_temporal_pcr_dataset(dataset_with_params, max_samples, get_samples_to_test):
    """Test basic functionality of SingleTemporalPCRDataset."""
