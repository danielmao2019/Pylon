...
def validate_meta_info(meta_info: Dict[str, Any], datapoint_idx: int) -> None:
    ...
    expected_keys = {'file_idx', 'transform_idx', 'transform_params', 'overlap', 'keep_ratio'}
    ...
    # crop_method removed - LiDAR is the only supported method
    ...
    required_config_keys = {'rotation_angles', 'translation', 'keep_ratio', 'seed'}
