...
def test_sysu_cd_different_data_root_different_hash(sysu_cd_data_root):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        dataset2 = SYSU_CD_Dataset(data_root=temp_dir, split='train')  # Different path will produce different hash
