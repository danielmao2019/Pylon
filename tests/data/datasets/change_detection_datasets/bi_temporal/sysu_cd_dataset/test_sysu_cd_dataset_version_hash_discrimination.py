...
def test_sysu_cd_same_parameters_same_hash(create_dummy_sysu_cd_files):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        dataset1a = SYSU_CD_Dataset(data_root=temp_dir, split='train')
        dataset1b = SYSU_CD_Dataset(data_root=temp_dir, split='train')
...
def test_sysu_cd_different_split_different_hash(create_dummy_sysu_cd_files):
    """Test that different splits produce different hashes."""
    
    with tempfile.TemporaryDirectory() as temp_dir:
        create_dummy_sysu_cd_files(temp_dir)
        
        dataset_train = SYSU_CD_Dataset(data_root=temp_dir, split='train')
        dataset_val = SYSU_CD_Dataset(data_root=temp_dir, split='val')
        dataset_test = SYSU_CD_Dataset(data_root=temp_dir, split='test')
...
def test_sysu_cd_different_data_root_different_hash(create_dummy_sysu_cd_files):
    """Test that different data roots produce different hashes."""
    
    with tempfile.TemporaryDirectory() as temp_dir1:
        with tempfile.TemporaryDirectory() as temp_dir2:
            create_dummy_sysu_cd_files(temp_dir1)
            create_dummy_sysu_cd_files(temp_dir2)
            
            dataset1 = SYSU_CD_Dataset(data_root=temp_dir1, split='train')
            dataset2 = SYSU_CD_Dataset(data_root=temp_dir2, split='train')
...
def test_sysu_cd_hash_format(create_dummy_sysu_cd_files):
...
def test_sysu_cd_comprehensive_no_hash_collisions(create_dummy_sysu_cd_files):
