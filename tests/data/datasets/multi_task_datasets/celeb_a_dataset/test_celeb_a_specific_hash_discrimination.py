...
def test_celeb_a_use_landmarks_discrimination(celeb_a_data_root):
    ...
    celeb_a_config = {
        ...
        'args': {'data_root': celeb_a_data_root, 'split': 'train'},
    }
    ...
    ), f"Different use_landmarks should produce different hashes: {hash_with} == {hash_without}"
...
def test_celeb_a_landmarks_split_combinations(celeb_a_data_root):
    ...
    for combination in test_combinations:
        config = {'class': CelebADataset, 'args': {**base_config, **combination}}
