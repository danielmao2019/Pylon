# Google Scholar Siamese KPConv Papers
...
8. **Classification of structural building damage grades from multi-temporal photogrammetric point clouds using a machine learning model trained on virtual laser scanning data**
...
13. **Weakly supervised semantic segmentation of mobile laser scanning point clouds via category balanced random annotation and deep consistency‐guided self-training**
...
14. **Multielement Feature-Based Hierarchical Context Integration Network for Remote Sensing Image Segmentation**
    - Authors: Y Yang, G Yuan, J Li
    - Year: 2024
...
15. **Radar translation network between sunny and rainy domains by combination of kp-convolution and cyclegan**
...
16. **DC3DCD: Unsupervised learning for multiclass 3D point cloud change detection**
...
17. **Correlated Mapping Attention Cooperative Network for Urban Remote Sensing Image Segmentation**
    - Authors: Y Yang, G Yuan, J Li
    - Year: 2024
    - Venue: IEEE Journal of Selected Topics in Applied Earth Observations and Remote Sensing
    - Citations: 1
...
18. **Dual-Branch Network for Spatial-Channel Stream Modeling Based on the State Space Model for Remote Sensing Image Segmentation**
    - Authors: Y Yang, G Yuan, J Li
    - Year: 2025
    - Venue: IEEE Transactions on Geoscience and Remote Sensing
...
19. **MSFD-Net: A Multiscale Spatial Feature Descriptor Network for Semantic Segmentation of Large-Scale Bridge Point Clouds**
...
20. **PGN3DCD: Prior-Knowledge-Guided Network for Urban 3D Point Cloud Change Detection**
...
21. **LaserSAM: Zero-Shot Change Detection Using Visual Segmentation of Spinning LiDAR**
...
22. **Multi-Context Point Cloud Dataset and Machine Learning for Railway Semantic Segmentation**
    - Authors: A Kharroubi, Z Ballouch, R Hajji, A Yarroudh, R Billen
    - Year: 2024
    - Venue: Infrastructures
    - Citations: 1
...
23. **Change of Scenery: Unsupervised LiDAR Change Detection for Mobile Robots**
...
24. **Optimal Transport for Change Detection on LiDAR Point Clouds**
...
25. **Deep learning with simulated laser scanning data for 3D point cloud classification**
...
26. **Landslide Detection in 3D Point Clouds With Deep Siamese Convolutional Network**
...
27. **A Change Detection Method for Misaligned Point Clouds in Mobile Robot System**
...
28. **"Low Supervision" Deep Cluster Change Detection (CDCluster) On Remote Sensing RGB Data: Towards The Unsupervising Clustering Framework**
...
29. **Deep Learning-based Change Detection and Classification for Airborne Laser Scanning Data**
    - Authors: J Nofulla
    - Year: 2023
...
30. **Construction scene change detection based on octree structure optimization**
    - Authors: X Liu, X Ge
    - Year: 2024
...
31. **Virtual laser scanning of dynamic scenes (VLS-4D): Current approaches and future perspectives in remote sensing**
...
32. **Photogrammetric rockfall monitoring in Alpine environments using M3C2 and tracked motion vectors**
...
34. **UAS 스마트 센서 기반 암벽사면 안전진단의 효용성 분석**
    - Authors: 이용창， 조은석， 강준오
    - Year: 2024
    - Venue: 한국측량학회지
    - Citations: Not specified
...
35. **3D CHANGE DETECTION FOR SEMI-AUTOMATIC UPDATE OF BUILDINGS IN 3D CITY MODELS**
