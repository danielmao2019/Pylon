...
class ChangeFormerV6(torch.nn.Module):
    ...
    def __init__(self, img_size: int, input_nc=3, output_nc=2, embed_dim=256):
        ...
        self.Tenc_x2 = EncoderTransformer_v3(img_size=img_size, patch_size = 7, in_chans=input_nc, num_classes=output_nc, embed_dims=self.embed_dims,
