...
class ChangeFormerV4(torch.nn.Module):
    ...
    def __init__(self, img_size: int, input_nc=3, output_nc=2):
        ...
        self.Tenc_x2 = EncoderTransformer_x2(img_size=img_size, patch_size=3, in_chans=input_nc, num_classes=output_nc, embed_dims=self.embed_dims,
