...
def LWGANet_L0_1242_e32_k11_GELU(num_classes=2, stem_dim=32, pretrained=None, pretrained_path=None, **kwargs):
...
def LWGANet_L1_1242_e64_k11_GELU(num_classes=2, stem_dim=64, pretrained=None, pretrained_path=None, **kwargs):
    model = LWGANet(in_chans=3,
                    num_classes=num_classes,
                    stem_dim=stem_dim,
                    depths=(1, 2, 4, 2),
...
def LWGANet_L2_1242_e96_k11_RELU(num_classes=2, stem_dim=96, pretrained=None, pretrained_path=None, **kwargs):
    model = LWGANet(in_chans=3,
                    num_classes=num_classes,
                    stem_dim=stem_dim,
                    depths=(1, 4, 4, 2),
