...
class FeatureFusionNeck(BaseModule):
    ...
    def __init__(
        self, policy, in_channels=None, channels=None, out_indices=(0, 1, 2, 3)
    ):
        super().__init__()
        self.policy = policy
    ...
    def forward(self, x1, x2):
        ...
        assert len(x1) == len(x2), (
            "The features x1 and x2 from the" "backbone should be of equal length"
        )
        outs = []
