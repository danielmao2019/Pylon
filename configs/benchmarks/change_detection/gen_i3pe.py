...
def add_heading(config: str) -> str:
    heading = ""
    heading += "# This file is automatically generated by `./configs/benchmarks/change_detection/gen_i3pe.py`.\n"
...
def main() -> None:
    ...
    for idx, seeded_config in enumerate(seeded_configs):
        ...
        seeded_config += f"config['work_dir'] = \"" + os.path.join("./logs", relpath, f"i3pe_sysu_cd_sysu_cd_run_{idx}") + "\"\n"
        with open(os.path.join("./configs", relpath, f"i3pe_sysu_cd_sysu_cd_run_{idx}.py"), mode='w') as f:
