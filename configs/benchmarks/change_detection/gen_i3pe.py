...
def main() -> None:
    ...
    for idx, seeded_config in enumerate(seeded_configs):
        ...
        seeded_config += f"config['work_dir'] = \"" + os.path.join("./logs", relpath, f"sysu_cd_sysu_cd_run_{idx}") + "\"\n"
        with open(os.path.join("./configs", relpath, f"sysu_cd_sysu_cd_run_{idx}.py"), mode='w') as f:
