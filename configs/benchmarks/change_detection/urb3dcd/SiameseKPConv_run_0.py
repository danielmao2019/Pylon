...
# Adjusted batch size and num_workers for stability
config['train_dataloader']['args']['batch_size'] = 1
config['train_dataloader']['args']['num_workers'] = 0
config['val_dataloader']['args']['batch_size'] = 1
config['val_dataloader']['args']['num_workers'] = 0
