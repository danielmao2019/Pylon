...
def main() -> None:
    ...
    config += '\n'
    # add seeds
    relpath = os.path.join("benchmarks", "change_detection", "xview2")
    ...
    for idx, seeded_config in enumerate(seeded_configs):
        ...
        seeded_config += f"config['work_dir'] = \"" + os.path.join("./logs", relpath, f"change_star_run_{idx}") + "\"\n"
        with open(os.path.join("./configs", relpath, f"change_star_run_{idx}.py"), mode='w') as f:
