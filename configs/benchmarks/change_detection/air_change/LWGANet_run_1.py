...
# model config
from configs.common.models.change_detection.lwganet import model_config
config['model'] = model_config

# criterion config
import criteria
config['criterion'] = {'class': criteria.vision_2d.change_detection.LWGANetCriterion, 'args': {}}

# setup distributed computing
if not torch.distributed.is_initialized():
	torch.distributed.init_process_group(backend='nccl',init_method='tcp://127.0.0.1:23456',rank=0,world_size=1)# seeds
...
# work dir
config['work_dir'] = "./logs/benchmarks/change_detection/air_change/LWGANet_run_1"
