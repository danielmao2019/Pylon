...
# model config
from configs.common.models.change_detection.bit_cd import model_config
config['model'] = model_config

# criterion config
import criteria
config['criterion'] = {'class': criteria.vision_2d.change_detection.BitCdCriterion, 'args': {}}
...
# work dir
config['work_dir'] = "./logs/benchmarks/change_detection/air_change/BIT-CD_run_2"
