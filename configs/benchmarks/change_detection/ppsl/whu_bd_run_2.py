...
config = {
    ...
    'train_dataset': {
        'class': PPSLDataset,
        'args': {
            'source': <data.datasets.semantic_segmentation_datasets.whu_bd_dataset.WHU_BD_Dataset object at 0x77ed46059d50>,
            'dataset_size': 4736,
            'transforms_cfg': {
                'class': Compose,
                'args': {
...
), (
    {
            'class': Randomize,
            'args': {
                'transform': <data.transforms.vision_2d.flip.Flip object at 0x77ed4605a200>,
                'p': 0.5,
            },
        },
    [('inputs', 'img_1'), ('inputs', 'img_2'), ('labels', 'change_map'), ('labels', 'semantic_map')]
), (
    {
            'class': Randomize,
            'args': {
                'transform': <data.transforms.vision_2d.flip.Flip object at 0x77ed4605a1a0>,
                'p': 0.5,
            },
        },
    [('inputs', 'img_1'), ('inputs', 'img_2'), ('labels', 'change_map'), ('labels', 'semantic_map')]
