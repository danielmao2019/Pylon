...
config = {
    ...
    'work_dir': './logs/benchmarks/point_cloud_registration/modelnet40/GMCNet_run_0',
    'epochs': 100,
    'init_seed': 51114888,
    ...
    'model': {
        ...
        'args': {
            'args': {
                'knn_list': '16,8,8',
                'down_sample_list': '8,16',
                'feature_size_list': '256,256,256,128',
                'use_cycle_loss': True,
                'use_mse_loss': True,
                'use_cd_loss': True,
                'use_inliers_loss': True,
                'reductioin': 'mean',
                'use_annealing': False,
                'rif_only': False,
                'rif_feature': 'ppf',
                'predict_inliers': True,
                'descriptor_size': 256,
                'use_weighted_procrustes': True,
            },
        },
    },
    'optimizer': {
