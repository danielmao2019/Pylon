...
from .orchestrators import RealDataBenchmarkOrchestrator, SyntheticBenchmarkOrchestrator
...
def main():
    ...
    if args.mode == "synthetic":
        ...
        report_generator.create_speed_vs_distance_by_dataset_plots(
            comprehensive_results, "synthetic"
        )
        # Second set: Speed vs dataset for each distance
        report_generator.create_speed_vs_dataset_by_distance_plots(
            comprehensive_results, "synthetic"
        )

        # Generate comprehensive summary report
        report_generator.create_comprehensive_summary_report(
            synthetic_results=comprehensive_results
        )
