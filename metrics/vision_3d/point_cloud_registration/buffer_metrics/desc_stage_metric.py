...
from criteria.vision_3d.point_cloud_registration.buffer_criteria.desc_loss import (
    ContrastiveLoss,
    cdist,
)
...
class BUFFER_DescStageMetric(SingleTaskMetric):
    ...
    def __call__(
        self, y_pred: Dict[str, Any], y_true: Dict[str, torch.Tensor], idx: int
