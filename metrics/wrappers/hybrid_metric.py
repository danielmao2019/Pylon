...
class HybridMetric(SingleTaskMetric):
    ...
    def __call__(
        ...
        """Override to properly handle component metrics that need idx parameter."""
        merged_scores = {}
        for metric in self.metrics:
            scores = metric(y_pred=y_pred, y_true=y_true, idx=idx)
        ...
        self.add_to_buffer(merged_scores, idx)
